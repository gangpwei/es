package com.wgp.essearch.service.impl;
...
import com.wgp.essearch.service.EsClientSearchService;
...
public class EsClientClientSearchServiceImpl implements EsClientSearchService {
    ...
    private List<Map<String, Object>> getHighLightResult(TreeMap<String, Object> content, boolean ishigh, SearchResponse searchResponse) {
